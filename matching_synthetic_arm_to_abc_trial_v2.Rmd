...
matches %>% 
  ...
  facet_grid(.~ cohort) +
  geom_histogram(alpha = 0.5, size = 0) +
  labs(subtitle = "Distribution of propensity scores",
       x = "Propensity score",
       y = "Density") +
...
MatchIt willl msot likely not work since we want to score a dataset independent of that used to train the model. We thus need a package or functions that undertake matching algortihms.
MatchIt offers:
