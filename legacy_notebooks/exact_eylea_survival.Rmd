...
* pmap so third parameter is the event as title (15 letetrs gain, etc.)

library(tidyverse)
df2 %>% 
   mutate(z = pmap(list(a, b, c), bind_rows))
   
* cowplot/patchwork intpo one (preferably with one legend)
...
```{r}
# messing solution to grouping
library(patchwork)

list <- list(eylea.exact.survival[[4]][[1]][[1]],
             eylea.exact.survival[[4]][[2]][[1]],
             eylea.exact.survival[[4]][[3]][[1]])

wrap_plots(list)
```
```{r}
eylea.exact.survival[[4]][[1]][[1]] /
eylea.exact.survival[[4]][[2]][[1]] /
eylea.exact.survival[[4]][[3]][[1]]
```
